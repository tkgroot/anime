...
var anime = (function () {
  ...
  function convertPxToUnit(el, decomposedValue, unit) {
    ...
    if (animatables) {
      ...
      if (unit) {
        ...
        if (decomposedValue.type === valueTypes.NUMBER || decomposedValue.type === valueTypes.UNIT) {
          var convertedValue = convertPxToUnit(animatable.target, decomposedValue, unit);
  ...
  function setTargetsValue(targets, properties) {
    ...
    animatables.forEach(function (animatable) {
      for (var property in properties) {
        ...
        splitValueUnit(value)[2];
        getOriginalAnimatableValue(animatable, property, animType); // const unit = valueUnit || splitValueUnit(originalValue)[2];

...
var anime = (function () {
  ...
  var is = {
    ...
    obj: function (a) { return a.constructor === Object; },
    ...
    pth: function (a) { return is.obj(a) && !is.und(a.totalLength); },
  };
  ...
  var setValueByType = [
    function (t, p, v) { return t[p] = v; },
    function (t, p, v) { return t.setAttribute(p, v); },
    function (t, p, v) { return t.style[p] = v; },
  ...
  function normalizeTweenValues(tween, animatable) {
    ...
    for (var p in tween) {
      ...
      if (is.arr(prop)) {
        prop = prop.map(function (v) { return getFunctionValue(v, animatable); });
        if (prop.length === 1) {
          prop = prop[0];
        }
      }
  ...
  function animate(params) {
    ...
    function syncInstanceChildren(time, muteCallbacks) {
      if (!instance.reversePlayback) {
        ...
        for (var j = childrenLength; j--;) { seekChild(time, children[j], muteCallbacks); }
      }
    }

...
const expectedFromRgbaValues = [255, 153, 153, 0.6];
...
const expectedToRgbaValues = [0, 255, 255, 0.8];
...
describe("Colors", () => {
  ...
  test("Hex3 to Hex3", () => {
    ...
    expect(animation.animations[0].tweens[0].from.numbers).toStrictEqual(
      expectedFromRgbValues
    );
    expect(animation.animations[0].tweens[0].to.numbers).toStrictEqual(
      expectedToRgbValues
    );
  });
  ...
  test("Hex3A to Hex3A", () => {
    ...
    expect(animation.animations[0].tweens[0].from.numbers).toStrictEqual(
      expectedFromRgbaValues
    );
    expect(animation.animations[0].tweens[0].to.numbers).toStrictEqual(
      expectedToRgbaValues
    );
  });

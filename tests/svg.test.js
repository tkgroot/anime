describe("SVG", () => {
  test("setDashoffset", () => {
    ...
    expect(
      dashOffsetAnimation.animations[0].tweens[0].from.numbers[0]
    ).toBeCloseTo(138.59292602539062, -0.5);
    expect(
      dashOffsetAnimation.animations[1].tweens[0].from.numbers[0]
    ).toBeCloseTo(138.59292602539062, -0.5);
    expect(
      dashOffsetAnimation.animations[2].tweens[0].from.numbers[0]
    ).toBeCloseTo(313.6517028808594, -0.5);
